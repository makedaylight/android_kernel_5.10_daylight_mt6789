...
uint8_t tcpm_inquire_typec_attach_old_new_state(
	struct tcpc_device *tcpc, uint8_t *old_state, uint8_t *new_state)
{
	*old_state = tcpc->typec_attach_old;
	*new_state = tcpc->typec_attach_new;
	return 0;
}
EXPORT_SYMBOL(tcpm_inquire_typec_attach_old_new_state);
