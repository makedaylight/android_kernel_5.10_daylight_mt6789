...
extern uint8_t tcpm_inquire_typec_attach_old_new_state( struct tcpc_device *tcpc, uint8_t *old_state, uint8_t *new_state);
...
static inline uint8_t tcpm_inquire_typec_attach_old_new_state(
				struct tcpc_device *tcpc, uint8_t *old_state, uint8_t *new_state)
{
	return TYPEC_UNATTACHED;
}
