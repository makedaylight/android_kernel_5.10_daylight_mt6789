...
err_free:
	...
	if (error == -EEXIST && !_strcasecmp(file_ext, ".ili"))
		return error;
#endif

	TP_MSG("MCU version: 0x%04x, Hex IC type: 0x%04x (result %d)\n",
		dev->mcu.ic_name, fw->file_ic_name, error);
