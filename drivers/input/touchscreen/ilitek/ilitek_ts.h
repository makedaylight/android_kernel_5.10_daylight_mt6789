...
#define	ILITEK_BLANK_POWERDOWN			MTK_DISP_BLANK_POWERDOWN
#define	ILITEK_BLANK_UNBLANK			MTK_DISP_BLANK_UNBLANK
#define	ILITEK_EVENT_BLANK				MTK_DISP_EVENT_BLANK
#define	ILITEK_BLANK_NORMAL				MTK_DISP_BLANK_UNBLANK
#endif
...
#define INOCO_RESUME_NORESET
#define INOCO_KEY_WAKEUP
#define INOCO_I2C_WAKEUP_SOURCE
#ifdef ILITEK_BOOT_UPDATE
#define INOCO_REDUCE_UPDATE_THREAD_DELAY
/**
 * If ILITEK_BOOT_UPDATE is defined and the ili FW is not updated due to -EEXIST error,
 * skip to update ilitek.hex and ilitek.bin in ilitek_update_thread().
 */
#define INOCO_BOOT_UPDATE_SKIPPED_ILI_NOT_ERROR
