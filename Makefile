...
ifeq ($(strip $(PCBA_BUILD)),yes)
KBUILD_AFLAGS += -DINOCO_PCBA_BUILD
KBUILD_CFLAGS += -DINOCO_PCBA_BUILD
KBUILD_CPPFLAGS += -DINOCO_PCBA_BUILD
#KBUILD_LDFLAGS += -DINOCO_PCBA_BUILD
endif
